...
* Выставление или обновление балла по имени или по ID
* Быстрое получение балла по имени или по ID за $O(\log N)$
* Вывод всех студентов и их текущих результатов
### Вариативная часть
1. Подсчет среднего балла по всем студентам
2. Нахождение студента с максимальным баллом
3. Нахождение студента с минимальным баллом
4. Вывод только тех студентов, чей балл не ниже заданного порога
5. Подсчет количества студентов, не прошедших заданный порог
6. Добавление удаления студента из журнала (по имени или по ID)
7. Проверка существования студента с заданным именем или ID
8. Сохранение данных электронного журнала в текстовый файл
